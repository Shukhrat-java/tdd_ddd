...
public class PhoneBookTest {
    ...
    public void testAdd() {
        ...
        assertEquals(2, phoneBook.add("Alice", "789")); // Дубли, не должены добавиться
    }
    ...
    public void testFindByNumber() {
        ...
        assertNull(phoneBook.findByNumber("999")); // Несуществующий номер
    }
    ...
    public void testPrintAllNames() {
        ...
        // Проверяем, что имена будут выведены в алфавитном порядке
